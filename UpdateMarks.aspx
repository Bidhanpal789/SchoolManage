<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="UpdateMarks.aspx.cs" Inherits="UpdateMarks" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="Server">
    Edit Marks | SchoolNest
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="Server">
    <div class="card shadow">
        <div class="card-body p-3">
            ...
            <div class="row">
                <div class="col-12">
                    <h6 class="bg-info-subtle p-2 mb-3 border">Edit Marks</h6>

                    <asp:GridView ID="grdSubjects" runat="server" AutoGenerateColumns="False"
                        DataKeyNames="subjectCode" CssClass="table table-bordered">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Obtained Marks">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtMarks" runat="server"
                                        Text='<%# Eval("ObtainedMarks") %>' CssClass="form-control" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
